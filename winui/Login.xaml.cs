...
namespace winui
{
    ...
    public sealed partial class Login : Window
    {
        ...
        public static int MinWindowWidth { get; set; } = 450;
        public static int MaxWindowWidth { get; set; } = 450;
        public static int MinWindowHeight { get; set; } = 300;
        public static int MaxWindowHeight { get; set; } = 300;
        public Login()
        {
